...
import type { PtyConfig, TerminalDataBatch, TerminalExitEvent, WebUIStatus } from '@shared/ipc'
import type { Terminal, Project, AppSettings, WebUISettings } from '@shared/types'
